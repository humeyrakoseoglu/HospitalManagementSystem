...
<div class="main_container">
        ...
        <div id="text_div">
            <p id="test_of_patients_table_text">TESTS OF ALL PATIENTS</p>
        </div>
        <table id="doctor_test_table">
            ...
            <?php
                ...
                JOIN appointment a ON a.appointmentID=hr.appointmentID AND a.appointmentStatus='Approved' ORDER BY testDate asc");
