...
<div class="main_container">
    <div class="container">
    <?php 
    $country_result = $db->prepare("SELECT DISTINCT t.testID,t.testName from hospitalrelation h,test t,appointment a where h.testID=t.testID and h.diagnosisID=0 and h.appointmentID=:appointmentID and t.testResult!='Not_Entered'");
...
<br>
<form action="operation/doctor_conclude_operation.php" method="post">
